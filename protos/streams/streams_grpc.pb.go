...
func (c *streamsClient) Read(ctx context.Context, in *ReadReq, opts ...grpc.CallOption) (Streams_ReadClient, error) {
	stream, err := c.cc.NewStream(ctx, &Streams_ServiceDesc.Streams[0], Streams_Read_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamsClient) Append(ctx context.Context, opts ...grpc.CallOption) (Streams_AppendClient, error) {
	stream, err := c.cc.NewStream(ctx, &Streams_ServiceDesc.Streams[1], Streams_Append_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamsClient) Delete(ctx context.Context, in *DeleteReq, opts ...grpc.CallOption) (*DeleteResp, error) {
	out := new(DeleteResp)
	err := c.cc.Invoke(ctx, Streams_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamsClient) Tombstone(ctx context.Context, in *TombstoneReq, opts ...grpc.CallOption) (*TombstoneResp, error) {
	...
	err := c.cc.Invoke(ctx, Streams_Tombstone_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamsClient) BatchAppend(ctx context.Context, opts ...grpc.CallOption) (Streams_BatchAppendClient, error) {
	stream, err := c.cc.NewStream(ctx, &Streams_ServiceDesc.Streams[2], Streams_BatchAppend_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
