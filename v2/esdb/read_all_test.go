...
func ReadAllTests(t *testing.T, populatedDBClient *esdb2.Client) {
...
func readAllEventsForwardsFromZeroPosition(db *esdb2.Client) TestCall {
...
func readAllEventsForwardsFromNonZeroPosition(db *esdb2.Client) TestCall {
	return func(t *testing.T) {
		...
		opts := esdb2.ReadAllOptions{
			From:           esdb2.Position{Commit: 1_788, Prepare: 1_788},
			ResolveLinkTos: true,
		}
...
func readAllEventsBackwardsFromZeroPosition(db *esdb2.Client) TestCall {
	return func(t *testing.T) {
...
func readAllEventsBackwardsFromNonZeroPosition(db *esdb2.Client) TestCall {
	return func(t *testing.T) {
		...
		opts := esdb2.ReadAllOptions{
			From:           esdb2.Position{Commit: 3_386, Prepare: 3_386},
			Direction:      esdb2.Backwards,
			ResolveLinkTos: true,
		}
