...
func TestStreamReads(t *testing.T) {
	...
	t.Run("TestReadStreamEventsForwardsFromZeroPosition", func(t *testing.T) {
		...
		assert.Equal(t, position.Position{Commit: -1, Prepare: -1}, events[0].Position)
		...
		assert.Equal(t, position.Position{Commit: -1, Prepare: -1}, events[1].Position)
		...
		assert.Equal(t, position.Position{Commit: -1, Prepare: -1}, events[2].Position)
		...
		assert.Equal(t, position.Position{Commit: -1, Prepare: -1}, events[3].Position)
		...
		assert.Equal(t, position.Position{Commit: -1, Prepare: -1}, events[4].Position)
		...
		assert.Equal(t, position.Position{Commit: -1, Prepare: -1}, events[5].Position)
		...
		assert.Equal(t, position.Position{Commit: -1, Prepare: -1}, events[6].Position)
		...
		assert.Equal(t, position.Position{Commit: -1, Prepare: -1}, events[7].Position)
		...
		assert.Equal(t, position.Position{Commit: -1, Prepare: -1}, events[8].Position)
		...
		assert.Equal(t, position.Position{Commit: -1, Prepare: -1}, events[9].Position)
		assert.Equal(t, "application/json", events[9].ContentType)
	})

	t.Run("TestReadStreamEventsBackwardsFromEndPosition", func(t *testing.T) {
		client := CreateTestClient(container, t)
		defer client.Close()
