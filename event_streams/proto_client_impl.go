...
func (this *ProtoClientImpl) GetReader(
	ctx context.Context,
...
const ProtoFailedToDeleteStreamErr = "ProtoFailedToDeleteStreamErr"

func (this *ProtoClientImpl) Delete(
	ctx context.Context,
	handle connection.ConnectionHandle,
	...
	if err != nil {
		err = this.grpcClient.HandleError(handle, headers, trailers, err)
		return DeleteResponse{}, errors.New(ProtoFailedToDeleteStreamErr)
	}
...
func (this *ProtoClientImpl) Tombstone(
	ctx context.Context,
	handle connection.ConnectionHandle,
...
func (this *ProtoClientImpl) GetBatchAppender(
	ctx context.Context,
